...
public class DietRecordController {
    ...
    public Result<DietRecordDto.Detail> addQuickRecordByUrls(
        ...
        DietRecordDto.Detail detail = dietRecordService.addQuickRecordByUrls(childId, quickInput.getImageList(), quickInput.getMealType(), quickInput.getRecordDate(),quickInput.getRecordTime(),quickInput.getPrompt());
